...
SECRET_KEY = 'django-insecure-0tnb726^orv%k5ufxurk_db$!6pjg4mztyjjo_$yj-5c1_mpgo'
...
SIMPLE_JWT = {
    ...
    'ROTATE_REFRESH_TOKENS': False,  # Optional: If you want to rotate refresh tokens, set to True
    'BLACKLIST_AFTER_ROTATION': False,  # Optional: Blacklist old refresh tokens after rotation
    'ALGORITHM': 'HS256',  # JWT algorithm, you can choose another if needed
    'SIGNING_KEY': 'your-secret-key',  # Secret key for signing the JWT
    'AUTH_HEADER_TYPES': ('Bearer',),  # Default is 'Bearer' for Authorization header
}
